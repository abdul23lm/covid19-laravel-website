...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Submit RS Rujukan</div>

                <div class="card-body">
                   {!! Form::model($hospital, ['route' => ['hospital.update', $hospital->id], 'method' => 'put', 'files' => true]) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('contact', null, [
                            'class' => $errors->has('contact') ? 'form-control is-invalid' : 'form-control',
                            'cols' => "10",
                            'rows' => "3"
                        ]) !!}
                        @error('contact')
